                ...
                <div className="max-w-7xl w-full mx-auto  sm:px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row w-full lg:space-x-8 space-y-2 lg:space-y-0 mb-2 lg:mb-4 items-center justify-center">
                        ...
                        <div className="w-full lg:w-1/5 cursor-pointer">
                            <div className="widget w-full p-4 rounded-lg bg-white border-l-4 border-purple-400 shadow-sm hover:shadow-green-400 hover:border-l-8 duration-100">
                                <div className="flex items-center">
                                    ...
                                    <div className="flex flex-col justify-center">
                                        ...
                                        <div className="text-sm text-gray-400">Chamados Abertos</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-1/5 cursor-pointer">
                            <div className="widget w-full p-4 rounded-lg bg-white border-l-4 border-green-400 shadow-sm hover:shadow-green-400 hover:border-l-8 duration-100">
                                <div className="flex items-center">
